## <small>5.0.5 (2020-12-13)</small>

* Update package references ([5c0675a](https://github.com/FollowThru/react-native-ui-kitten/commit/5c0675a))
* Update package.json's and scripts ([8f5f9eb](https://github.com/FollowThru/react-native-ui-kitten/commit/8f5f9eb))
