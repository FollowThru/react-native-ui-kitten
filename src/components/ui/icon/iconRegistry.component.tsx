 ...
 * import { ApplicationProvider, IconRegistry, Layout, Text, Icon, Button } from '@followthru/ui-kitten-components';
 * import { EvaIconsPack } from '@followthru/ui-kitten-eva-icons'; // <-- Make sure it is installed. npm i @followthru/ui-kitten-eva-icons
 *
