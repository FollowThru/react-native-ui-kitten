 ...
 * import { BottomNavigation, BottomNavigationTab, Layout, Text } from '@followthru/ui-kitten-components';
 *
 ...
 * ```
 * import { BottomNavigationTab, Text } from '@followthru/ui-kitten-components';
 *
 * <BottomNavigationTab
