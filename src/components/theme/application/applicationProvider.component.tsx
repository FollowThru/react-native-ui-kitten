 ...
 * Can be improved with build-time processing with `@followthru/ui-kitten-metro-config` package.
 *
 ...
 * Usually, can be provided by `@followthru/ui-kitten-metro-config` package.
 *
 ...
 * ```
 * import React from 'react';
 * import { ApplicationProvider, Layout, Text } from '@followthru/ui-kitten-components';
 ...
 * ```
 * import React from 'react';
 * import { ApplicationProvider, IconRegistry, Layout, Text } from '@followthru/ui-kitten-components';
 * import { EvaIconsPack } from '@followthru/ui-kitten-eva-icons';
 * import * as eva from '@eva-design/eva';
 *
 * export default () => (
 *   <React.Fragment>
